	...
	$(function(){
		...
		//导航栏翻转效果
			...
			$("#top_box #top ul#menu2 li a").hover(function() {
				$(".out",	this).animate({'top':	'40px'},	100,function(){document.title=0;}); // move down - hide
				$(".over",	this).animate({'top':	'0px'},		100); // move down - show
			}, function() {
				$(".out",	this).animate({'top':	'0px'},		300); // move up - show
				$(".over",	this).animate({'top':	'-40px'},	300); // move up - hide
			});
		//左侧二级菜单效果
